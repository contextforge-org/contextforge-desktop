 ...
 */
export const rootInfoGet = <ThrowOnError extends boolean = false>(options?: Options<RootInfoGetData, ThrowOnError>) => (options?.client ?? client).get<RootInfoGetResponses, unknown, ThrowOnError>({ url: '/', ...options });
