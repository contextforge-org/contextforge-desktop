...
interface ServerFilterDropdownProps {
  theme: string;
  filters: Filters;
...
export function ServerFilterDropdown({
  theme,
  filters,
  hasActiveFilters,
  uniqueNames,
    ...
    <DropdownMenu>
      ...
      >
        ...
        <FilterCategory
          ...
          onToggle={(transport) => onToggleFilter('transports', transport)}
          theme={theme}
          onSelectAll={() => onSelectAll('transports', uniqueTransports)}
          onDeselectAll={() => onDeselectAll('transports')}
        />
